...
export class PaymentController {
  ...
  @ApiParam({ name: 'id', description: 'Escrow account ID', type: String })
  @ApiBody({ schema: { properties: { amount: { type: 'number' }, description: { type: 'string', required: false } } } })
  ...
  @ApiParam({ name: 'id', description: 'Disbursement ID', type: String })
  @ApiBody({ schema: { properties: { approvedBy: { type: 'string' }, notes: { type: 'string', required: false } } } })
  ...
  @ApiParam({ name: 'id', description: 'Disbursement ID', type: String })
  @ApiBody({ schema: { properties: { amount: { type: 'number', required: false } } } })
