...
export declare class PayoutService {
    ...
    rejectPayoutRequestWithDto(payoutRequestId: string, rejectPayoutDto: any): Promise<PayoutRequest>;
    ...
    createDisbursementSchedule(disbursementId: string, installments: Array<{
        amount: number;
        dueDate: Date;
    ...
    calculateFees(amount: number): Promise<{
